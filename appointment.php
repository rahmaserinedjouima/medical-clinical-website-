...
<?php endif; ?>
            ...
            <form id="appointmentForm" action="php/process_appointment.php" method="POST" enctype="multipart/form-data" novalidate>
                ...
                <div class="form-group">
                    ...
                    <small class="helper" id="ageDisplay">Age: —</small>
...
<button class="btn-submit" type="submit" <?php if(!$loggedIn) echo 'disabled'; ?>>Send Message</button>
        ...
        <aside class="card-right">
                ...
                <p>Mon–Fri: 8am - 8pm<br>Sat: 9am - 5pm</p>
                </div>
              <div class="emergency">
                <h4> 📞CALL US </h4>
                <p>+213 21 45 67 89</p>
...
$(function(){
    ...
    const doctorList = {
       "General Consultation": ["Dr. Alia", "Dr. Houssam"],
  "Pediatric Consultation": ["Dr. Sofia"],
  "Cardiology Consultation": ["Dr. Ahmed"],            
  "Dermatology Consultation": ["Dr. Alicia"],            
  "Gynecology & Obstetrics Consultation": ["Dr. Ayoub"],
  "Emergency Consultation": ["Dr. Karim"],               
  "Medical Imaging": ["Dr. Samia"],                        
  "Dental Checkup": ["Dr. Mahdi"], // same name, but different doctor card image if needed
  "Physiotherapy Session": ["Dr. Ahlem"],
  "Vaccination": ["Dr. Lamine"],
  "Lab Test": ["Dr. Labidi"],
  "Follow-up Appointment": ["Dr. Alia", "Dr. Houssam"],
  "Special Consultation": ["Dr. Lina", "Dr. Lidia"]
};
    ...
    $('#birthdate').on('change', function(){
        const v = $(this).val();
        if(!v) { $('#ageDisplay').text('Age: —'); return; }
        const b = new Date(v);
